...
public class PdaxOrderDetails {
  ...
  public PdaxOrderDetails(
      @JsonProperty("order_id") long orderId,
      @JsonProperty("order_type") String orderType,
      @JsonProperty("traded_currency") String tradeCurrency,
      @JsonProperty("amount") BigDecimal amount,
      @JsonProperty("side") String sell,
      @JsonProperty("settlement_currency") String settlementCurrency,
      @JsonProperty("order_status") String orderStatus,
      @JsonProperty("outstanding_traded_currency_amount")
          BigDecimal outstandingTradedCurrencyAmount,
      @JsonProperty("limit_price") BigDecimal limitPrice,
      @JsonProperty("trades") List<PdaxOrderTrades> trades,
  ...
  public String toString() {
    return "PdaxOrderDetails [orderId="
        + orderId
        + ", orderType="
        + orderType
        + ", tradeCurrency="
        ...
        + ", orderStatus="
        + orderStatus
        + ", outstandingTradedCurrencyAmount="
        + outstandingTradedCurrencyAmount
        + ", limitPrice="
        + limitPrice
        + ", trades="
